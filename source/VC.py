...
from source.PhoneControl import PhoneControl
import numpy as np
...
class VC(PhoneControl, OCR):
    ...
    def __init__(self, phone):
        ...
        """
        # 以下写法不理解，请参考https://stackoverflow.com/questions/11179008/python-inheritance-typeerror-object-init-takes-no-parameters
