...
from source.config import OCR_NO_WORDS
...
class OCR():
    ...
    def pre_process_img(pic_file_name, quality=50, crop=None):
        ...
        # 之所以存储为jpg格式，是因为百度OCR官方文档中写了，JPG格式识别准确率更高，而且JPG格式压缩比更高，
        # 更利于网络传输
        rgb_im.save(pic_file_name, optimize=True, quality=quality)
