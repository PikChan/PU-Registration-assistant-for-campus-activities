...
#     # @connect_phone
    def get_screen_cap(self, file_name='screen_cap'):
        ...
        获取截图
        """
        system('adb -s '+str(self.phone)+' shell screencap -p /sdcard/'+file_name+'.jpg')
        system('adb -s '+str(self.phone)+' pull /sdcard/'+file_name+'.jpg'+' ./'+file_name+'.jpg')
